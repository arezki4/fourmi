 ...
 **/
void diminuer_1_PheroSucre (Grille g){
    Coord c ;
    Place p ;
      for (int i =0;i<MAXGRILLE ; i++) {
         for (int j = 0 ; j < MAXGRILLE ; j++ ) {
...
//////////////////////////////////Fonction pour Affichage non interactif//////////////////////////////////////////////
...
/////////////////////////////////Fonction qui met a jour une fourmi//////////////////////////////////////
 ...
 * @param[in/out] f : la fourmi qu'on veux mettre a jour
   return : une coordonnée
 */
void MAJfourmi(Grille g , Fourmi &f ) {
   Coord cv ;
   Place pv ;
